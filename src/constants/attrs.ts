export const ID_EDITOR_VDITOR = 'j-new-tab-editor-vditor'

export const CLS_DROP_ZONE = 'drop-zone'
...
export const CLS_STYLE_EDIT_DONE = 'cls-card-edit-done'
...
export const DatasetKeyDragCardUniqueId = 'data-drag-card-unique-id'
export const DatasetKeyDragCardStatus = 'data-drag-card-status'